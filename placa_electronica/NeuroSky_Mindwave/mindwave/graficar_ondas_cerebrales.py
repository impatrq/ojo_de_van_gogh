...
def main():
    ...
    # .readSerialStart()                                               # starts background thread
    ...
    anim = animation.FuncAnimation(fig,Arduino.readline() , fargs=(lines, lineValueText, lineLabel, timeText), interval=pltInterval)    # fargs has to be a tuple
